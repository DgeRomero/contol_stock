<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="agregarProducto.aspx.cs" Inherits="ControlStock.agregarProducto" %>
        ...
        <div class="mb-2">
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <asp:TextBox ID="txtImagen" runat="server" CssClass="form-control" AutoPostBack="true" ></asp:TextBox>
